    ...
    @php
        $roleBadge = function ($role) {
            ...
            return match ($role) {
                ...
                'publisher' => 'bg-yellow-50 text-yellow-800 border-yellow-200',
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 px-4 py-10">
                ...
                <div class="mt-4 flex flex-col md:flex-row md:items-end md:justify-between gap-4">
                    <div>
                        ...
                        <p class="mt-2 text-gray-600">
                            Ubah role user (user/publisher/admin) dengan cepat.
                        </p>
                    </div>
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm mb-5">
                <div class="flex flex-col md:flex-row md:items-end gap-3">
                    <div class="flex-1">
                        <label class="block text-xs font-semibold text-gray-600 mb-2">Cari user</label>
                        <input id="userSearch"
                               type="text"
                    ...
                    <div class="flex gap-2">
                        <button id="userReset" type="button" class="{{ $btnWhite }}">
                            Reset
                        </button>
                        ...
                        <div class="inline-flex items-center gap-2 px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-sm">
                            ...
                            <span id="userCount" class="font-extrabold text-gray-900">0</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="w-full text-sm">
                        <thead class="bg-gray-50 sticky top-0">
                            <tr class="border-b text-left">
                                <th class="py-3 px-4 font-extrabold text-gray-700">Name</th>
                                <th class="py-3 px-4 font-extrabold text-gray-700">Email</th>
                                <th class="py-3 px-4 font-extrabold text-gray-700">Role</th>
                        ...
                        <tbody id="usersTbody" class="divide-y">
                            @foreach($users as $u)
                                ...
                                <tr class="hover:bg-gray-50 transition"
                                    ...
                                    <td class="py-3 px-4">
                                        <span class="inline-flex items-center px-3 py-1 rounded-full border text-xs font-extrabold {{ $roleBadge($role) }}">
                                            {{ $role }}
                                        </span>
                                    </td>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const apply = () => {
                ...
                rows.forEach(r => {
                    ...
                    const ok = !q || name.includes(q) || email.includes(q) || role.includes(q);
